r<%@ Page Language="C#" AutoEventWireup="true" CodeFile="superAdminHome.aspx.cs" Inherits="superAdminHome" %>
            ...
            function addAdvice() {
                $.alert({
                    ...
                    content: "<div class='row pad' style='width: 100%; background: #ECF0F5'>" +
                        ...
                        "<input class='form-control' type='text' disabled value='Subjects Failed Percentage'/>" +
                        "</div>" +
                        "</div>" +
                        "<div class='box-body'>" +
                        "<input type='text' class='slider form-control' data-slider-min='0' data-slider-max='100'" +
                    ...
                    onContentReady: function () {
                        this.$content.find(".slider").slider();
                    },
                });
            }
